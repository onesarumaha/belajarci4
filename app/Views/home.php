...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="<?= base_url() ?>/template2/html/dashboard/assets/images/favicon.ico" />
      
      <!-- Library / Plugin Css Build -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/css/core/libs.min.css" />
      
      <!-- Aos Animation Css -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/vendor/aos/dist/aos.css" />
      
      <!-- Hope Ui Design System Css -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/css/hope-ui.min.css?v=1.2.0" />
      
      <!-- Custom Css -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/css/custom.min.css?v=1.2.0" />
      
      <!-- Dark Css -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/css/dark.min.css"/>
      
      <!-- Customizer Css -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/css/customizer.min.css" />
      
      <!-- RTL Css -->
      <link rel="stylesheet" href="<?= base_url() ?>/template2/html/dashboard/assets/css/rtl.min.css"/>
...
<div class="row">
   ...
   <div class="col-md-12 col-lg-4">
    ...
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/core/libs.min.js"></script>
    
    <!-- External Library Bundle Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/core/external.min.js"></script>
    
    <!-- Widgetchart Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/charts/widgetcharts.js"></script>
    
    <!-- mapchart Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/charts/vectore-chart.js"></script>
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/charts/dashboard.js" ></script>
    
    <!-- fslightbox Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/plugins/fslightbox.js"></script>
    
    <!-- Settings Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/plugins/setting.js"></script>
    
    <!-- Slider-tab Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/plugins/slider-tabs.js"></script>
    
    <!-- Form Wizard Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/plugins/form-wizard.js"></script>
    
    <!-- AOS Animation Plugin-->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/vendor/aos/dist/aos.js"></script>
    
    <!-- App Script -->
    <script src="<?= base_url() ?>/template2/html/dashboard/assets/js/hope-ui.js" defer></script>
  </body>
</html>